...
import profile from "../assets/BpsInfo.png";
...
export default function Hiro() {
  ...
  return (
    <>
      ...
      >
        <div className="md:w-3/6 md:p-4 mt-7.5">
          <img
            data-aos="flip-right"
        ...
        >
          <div className="flex flex-col w-full mt-8">
            ...
            <h1 className="text-3xl font-bold">Bishnu Sahoo</h1>
            <p className="text-2xl font-bold text-gray-300">FrontEnd Developer</p>
            <p className="text-xl font-light text-gray-400 ">
              Enthusiastic and motivated self-learning in Information
              Technology. Interested in exploring about Full Stacks like React,
              Angular, Express & MongoDB. Now I am looking for more experience
              in my field.
            </p>
          </div>
          ...
          <ul className="flex mt-2 gap-4 items-center">
            <li>
              <a
                href="https://github.com/Bishnu-Mern"
                rel="noreferrer"
                target="_blank"
              >
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/bishnu-sahoo-775b401b5"
                rel="noreferrer"
                target="_blank"
              >
